...
class HeadlessCircuit {
  constructor(data, {
    ...
    engineOptions = {},
    defaultCombinationalPropagation
  } = {}) {
  ...
  _makeGraph(data, subcircuits, opt) {
    ...
    for (const devid in data.devices) {
      ...
      if (this._defaultCombinationalPropagation !== undefined && !('propagation' in cellArgs) && cellType.prototype._gateKind == 'combinational') cellArgs.propagation = this._defaultCombinationalPropagation;
