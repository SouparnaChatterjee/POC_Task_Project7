...
const Wire = exports.Wire = joint.shapes.standard.Link.define('Wire', {
  ...
  getWireParams(layout) {
    ...
    if (layout && this.has('vertices') && this.get('vertices').length > 0) connector.vertices = joint.util.cloneDeep(this.get('vertices'));
    return connector;
  },
  getWirePath() {
    const hier = [];
